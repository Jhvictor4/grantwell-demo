-- Phase 3: Workflows & Data Tracking Database Schema (Fixed)
...
-- Insert sample process trackers for existing grants (fixed to use correct enum values)
...
SELECT 
  ...
  CASE g.status 
    ...
    WHEN 'active' THEN 'Active Management'
    WHEN 'closed' THEN 'Closeout'
    ELSE 'Planning'
  END,
  4,
  CASE g.status 
