...
-- This ensures all grants in preparation+ stages have proper checklists

-- Insert default task templates for grants without tasks
INSERT INTO tasks (
  grant_id,
  title,
  description,
...
-- Create closeout logs for awarded grants that don't have them
...
CROSS JOIN (
  VALUES 
    ('final_narrative', 'Submit final project narrative report'),
    ('final_sf425', 'Complete and submit final SF-425 Federal Financial Report'),
    ('equipment_disposition', 'Provide equipment disposition documentation'),
    ('unspent_funds', 'Return any unspent federal funds')
