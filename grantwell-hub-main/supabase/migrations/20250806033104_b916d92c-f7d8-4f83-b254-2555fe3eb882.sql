...
-- Create closeout logs for awarded grants using the correct log_type values
...
CROSS JOIN (
  VALUES 
    ('final_report', 'Submit final project narrative report'),
    ('fiscal_closeout', 'Submit final SF-425 Federal Financial Report'),
    ('final_submission', 'Complete final grant submission and documentation')
